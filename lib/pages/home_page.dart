          ...
          body: FutureBuilder(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                String bannerPic = data['data']['advertesPicture']
                    ['PICTURE_ADDRESS']; //广告banner
                ...
                return EasyRefresh(
                  ...
                  child: ListView(
                    children: <Widget>[
                      MySwiperDiy(swiperDataList: swiperDataList),
...
// 轮播图
class MySwiperDiy extends StatelessWidget {
  final List swiperDataList;
  MySwiperDiy({Key key, this.swiperDataList}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
